...
np.savetxt('pred_20_stages_' + str(seed) + '.csv',y, delimiter =",", fmt = '% s')


###### Run pareto.py to sort solution before running following lines #####

# read the solutions on Pareto frontier
dd_pp = 'parsed_pred_20_stages_' + str(seed) + ".csv"
...
np.savetxt('mp_pred_20_stages_' + str(seed)+ '.csv', mp, delimiter =",", fmt = '% s')
