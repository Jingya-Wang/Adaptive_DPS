...
mp_1 = pd.read_csv('mp_pred_20_stages_0.csv', header = None)
mp_1 = mp_1.to_numpy()

mp_2 = pd.read_csv('mp_pred_20_stages_19.csv', header = None)
mp_2 = mp_2.to_numpy()

mp_3 = pd.read_csv('mp_pred_20_stages_29.csv', header = None)
mp_3 = mp_3.to_numpy()

mp_4 = pd.read_csv('mp_pred_20_stages_39.csv', header = None)
mp_4 = mp_4.to_numpy()

mp_5 = pd.read_csv('mp_pred_20_stages_42.csv', header = None)
mp_5 = mp_5.to_numpy()

mp_6 = pd.read_csv('mp_pred_20_stages_49.csv', header = None)
mp_6 = mp_6.to_numpy()

mp_7 = pd.read_csv('mp_pred_20_stages_59.csv', header = None)
mp_7 = mp_7.to_numpy()

mp_8 = pd.read_csv('mp_pred_20_stages_69.csv', header = None)
mp_8 = mp_8.to_numpy()

mp_9 = pd.read_csv('mp_pred_20_stages_119.csv', header = None)
mp_9 = mp_9.to_numpy()

mp_10 = pd.read_csv('mp_pred_20_stages_159.csv', header = None)
...
def selections(time_stage, years, time_step, new_water_level, n_years, bin_matrix):
    ...
    timestage11_name = pickup_strategy(probs[:,9], beliefs_space, 10)
    timestage12_name = pickup_strategy(probs[:,10], beliefs_space, 11)
    timestage13_name = pickup_strategy(probs[:,11], beliefs_space, 12)
    timestage14_name = pickup_strategy(probs[:,12], beliefs_space, 13)
    timestage15_name = pickup_strategy(probs[:,13], beliefs_space, 14)
    timestage16_name = pickup_strategy(probs[:,14], beliefs_space, 15)
    timestage17_name = pickup_strategy(probs[:,15], beliefs_space, 16)
    timestage18_name = pickup_strategy(probs[:,16], beliefs_space, 17)
    timestage19_name = pickup_strategy(probs[:,17], beliefs_space, 18)
    timestage20_name = pickup_strategy(probs[:,18], beliefs_space, 19)
...
timestage18_name, timestage19_name, timestage20_name)
    ...
    for i in range(len(mp)):
        total_inv, total_s = total_inv_s(mp[i,0:12], mp[i,(timestage2_name-1)*12 : (timestage2_name-1)*12+12],\
                                         ...
                                         mp[i,(timestage11_name-1)*12 : (timestage11_name-1)*12+12], \
                                         mp[i,(timestage12_name-1)*12 : (timestage12_name-1)*12+12], \
                                         mp[i,(timestage13_name-1)*12 : (timestage13_name-1)*12+12], \
                                         mp[i,(timestage14_name-1)*12 : (timestage14_name-1)*12+12], \
                                         mp[i,(timestage15_name-1)*12 : (timestage15_name-1)*12+12], \
                                         mp[i,(timestage16_name-1)*12 : (timestage16_name-1)*12+12], \
                                         mp[i,(timestage17_name-1)*12 : (timestage17_name-1)*12+12], \
                                         mp[i,(timestage18_name-1)*12 : (timestage18_name-1)*12+12], \
                                         mp[i,(timestage19_name-1)*12 : (timestage19_name-1)*12+12], \
                                         mp[i,(timestage20_name-1)*12 : (timestage20_name-1)*12+12], \
                                         one_water_level)
...
for i in range(len(water_level)):
    ...
    timestage11_name, timestage12_name, timestage13_name, timestage14_name, timestage15_name, timestage16_name, timestage17_name,\
timestage18_name, timestage19_name, timestage20_name = selections(time_stage, years, time_step, new_water_level, n_years, bin_matrix)
...
np.savetxt('final_20_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
...
invAs = np.array((final_inv, final_s))
invAs = invAs.T
np.savetxt('low_final_20_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
...
invAs = np.array((final_inv, final_s))
invAs = invAs.T
np.savetxt('medium_final_20_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
...
invAs = np.array((final_inv, final_s))
invAs = invAs.T
np.savetxt('high_final_20_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
