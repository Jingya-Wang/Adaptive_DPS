...
timestage8_name, timestage9_name, timestage10_name
...
def mapping(sow, one_water_level,timestage1_name,timestage2_name,timestage3_name, timestage4_name,timestage5_name,timestage6_name,\
           ...
           timestage7, timestage8, timestage9, timestage10):
    ...
    if len(ss) == 0:
        ...
        for i in range(len(strategy_1)):
            ind_1 = ind_2 = ind_3 = ind_4 = ind_5 = ind_6 = ind_7 = ind_8 = ind_9 = ind_10 = i
            total_inv, total_s = total_inv_s(timestage1[ind_1,:], timestage2[ind_2,:], timestage3[ind_3,:],\
                                                        timestage4[ind_4,:], timestage5[ind_5,:], timestage6[ind_6,:], \
                                             timestage7[ind_7,:], timestage8[ind_8,:], timestage9[ind_9,:], timestage10[ind_10,:],\
                                             one_water_level)
...
for i in range(len(water_level)):
    ...
    timestage1, timestage2, timestage3, timestage4, timestage5, timestage6, timestage7, timestage8, timestage9, timestage10,\
    timestage1_name, timestage2_name, timestage3_name, timestage4_name, timestage5_name, timestage6_name, timestage7_name,\
    timestage8_name, timestage9_name, timestage10_name= selections(time_stage, years, time_step, new_water_level, n_years, bin_matrix)
...
invAs = invAs.T
np.savetxt('new_re_cal_10_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
...
invAs = invAs.T
np.savetxt('low_new_10_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
...
invAs = invAs.T
np.savetxt('medium_new_10_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
...
invAs = invAs.T
np.savetxt('high_new_10_stages.csv',  invAs, delimiter =", ",  fmt ='% s')
